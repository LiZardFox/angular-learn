...
export function modelHoveredAnimation<
  TAnimationApi extends NgtsAnimationApi<NgtsAnimationClip> & { isReady: true },
>(
  hovered: () => boolean,
  ...
  const animationName = computed(() =>
    hovered() ? hoverAnimationName : defaultAnimationName,
  );
  effect(() => {
